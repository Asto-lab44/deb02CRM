...
(function () {
  ...
  // ───────────────────────────────────────────────────────────────────
  // ── Défauts fournisseurs (109 lignes importées du tableau compta Astorya)
  // Sert de fallback quand ni Supabase ni le cache local ne contiennent
  // encore de fournisseurs. Chaque ligne porte data.cost_bracket (répartition
  // par coûts) + data.importance (strategique/important/standard/secondaire)
  // et data.importance_note (2..5) = note d'importance pour l'entreprise.
const SUPPLIER_DEFAULTS = [{"id": "SUP-DEDIBOX", "name": "DEDIBOX", "payment_terms": "immédiat", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "account_number": "401DED", "payment_type": "prélèvement et virement", "invoice_mailbox": "telechargement via leur site , factures a telecharger , voir sur la boite mail contact , demander une redirection vers boite mail facture, contacter le commercial et lui demander à passer à 30 jours  prendre les codes aupres de laurent - aller chercher les factures à la main", "tva_intracom": "275"}}, {"id": "SUP-ACTUALSYSTEMES", "name": "ACTUAL SYSTEMES", "payment_terms": "30 jours", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "payment_type": "prélèvement", "invoice_mailbox": "facture", "tva_intracom": "290"}}, {"id": "SUP-TDSYNNEX", "name": "TD SYNNEX", "payment_terms": "30 jours", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "payment_type": "prélèvement et virement", "invoice_mailbox": "facture", "tva_intracom": "286"}}, {"id": "SUP-OVH", "name": "OVH", "payment_terms": "30 jours", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "payment_type": "prélèvement et carte", "invoice_mailbox": "aller chercher", "tva_intracom": "276"}}, {"id": "SUP-SERVEURCOM", "name": "SERVEURCOM", "payment_terms": "30 jours", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-BECLOUD", "name": "BE CLOUD", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "+50 000€", "importance": "strategique", "importance_note": 5, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-SARLOKTEY", "name": "SARL OKTEY", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "account_number": "401OKT", "payment_type": "virement / prélèvement", "invoice_mailbox": "compta"}}, {"id": "SUP-EBPINFORMATIQU", "name": "EBP INFORMATIQUE", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "prélèvement", "invoice_mailbox": "regarder vers boite contact idem dedibox", "tva_intracom": "285"}}, {"id": "SUP-OCTOPUS", "name": "OCTOPUS", "payment_terms": "virement automatique (demander la date à clement )", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-INGRAM", "name": "INGRAM", "payment_terms": "Virement pour le cloud et prelevement pour le materiel", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "prélèvement, virement et carte", "invoice_mailbox": "facture", "tva_intracom": "291"}}, {"id": "SUP-GUILLAUMESOURI", "name": "GUILLAUME SOURISSEAU", "payment_terms": "aléatoire", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-CIDIT", "name": "CID-IT", "payment_terms": "immédiat on ne peut pas passer à 30 jours à redemander quand même ,,,,", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "virement et carte", "invoice_mailbox": "facture"}}, {"id": "SUP-3CX", "name": "3CX", "payment_terms": "immédiat demanderà  passer à 30 jours à redemander quand même ,,,,", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "carte", "invoice_mailbox": "à rajouter boite mail compta (demander à laurent - rajouter un utilisateur facture en admin)+"}}, {"id": "SUP-AMAZON", "name": "AMAZON", "payment_terms": "immédiat", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "prélèvement", "invoice_mailbox": "aucune on doit les telecharger"}}, {"id": "SUP-ALSO", "name": "ALSO", "payment_terms": "30 jours fin de mois", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "prélèvement", "invoice_mailbox": "facture", "tva_intracom": "277"}}, {"id": "SUP-DEXXON", "name": "DEXXON", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "10 000€ - 50 000€", "importance": "important", "importance_note": 4, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-AUDITCONSEILEX", "name": "AUDIT CONSEIL EXPERTISE", "payment_terms": "30 jours", "data": {"cost_bracket": "5 000€ - 10 000€", "importance": "standard", "importance_note": 3, "account_number": "401AUD", "payment_type": "prélèvement", "invoice_mailbox": "a rechercher , demander à les envoyer à factures"}}, {"id": "SUP-APOGEA", "name": "APOGEA", "payment_terms": "FDM 30/", "data": {"cost_bracket": "5 000€ - 10 000€", "importance": "standard", "importance_note": 3, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-ATHENAGLOBALSE", "name": "ATHENA GLOBAL SERVICES", "payment_terms": "15 jours, FDM30", "data": {"cost_bracket": "5 000€ - 10 000€", "importance": "standard", "importance_note": 3, "payment_type": "prélèvement et virement", "invoice_mailbox": "facture", "tva_intracom": "278"}}, {"id": "SUP-SYNOLOGY", "name": "SYNOLOGY", "payment_terms": "immédiat FDM30 c2", "data": {"cost_bracket": "5 000€ - 10 000€", "importance": "standard", "importance_note": 3, "payment_type": "prélèvement", "invoice_mailbox": "facture", "tva_intracom": "279"}}, {"id": "SUP-SAGECIEL", "name": "SAGE CIEL", "payment_terms": "244", "data": {"cost_bracket": "5 000€ - 10 000€", "importance": "standard", "importance_note": 3, "payment_type": "prélèvement", "tva_intracom": "271"}}, {"id": "SUP-AUDITCONSEILRE", "name": "AUDIT CONSEIL REZE", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "account_number": "401AUR", "payment_type": "prélèvement"}}, {"id": "SUP-UBIQUITI", "name": "UBIQUITI", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "changer la redirection de la facture vers facture"}}, {"id": "SUP-EDOX", "name": "EDOX", "payment_terms": "30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-TOTALENERGIE", "name": "TOTAL ENERGIE", "payment_terms": "15 jours demander FDM30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement"}}, {"id": "SUP-GLOBALSIGNGMO", "name": "GLOBALSIGN GMO", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement et carte", "invoice_mailbox": "a chercher", "tva_intracom": "292"}}, {"id": "SUP-SSTRNSERVICEDE", "name": "SSTRN (Service de Santé au Tra", "payment_terms": "30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-WATSOFT", "name": "WATSOFT", "payment_terms": "30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-MUSCADE", "name": "MUSCADE", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-SEWANCOMMUNICA", "name": "SEWAN COMMUNICATIONS", "payment_terms": "15 jours demander FDM30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-AGLO", "name": "AGLO", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-AUTODESK", "name": "AUTODESK", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-MONDAY", "name": "MONDAY", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr 1x par an"}}, {"id": "SUP-TELAVOX", "name": "TELAVOX", "payment_terms": "aléatoire :demander 30 jours fin de mois", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture", "tva_intracom": "289"}}, {"id": "SUP-ALIBABA", "name": "ALIBABA", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-EMERAUDEPROPRE", "name": "EMERAUDE PROPRETE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-PASSBOLT", "name": "PASSBOLT", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "facture"}}, {"id": "SUP-FREEPRO", "name": "FREE PRO", "payment_terms": "30 jours FdM", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture", "tva_intracom": "280"}}, {"id": "SUP-DKV", "name": "DKV", "payment_terms": "15 jours demander FDM30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture depuis service compta"}}, {"id": "SUP-ALLIANCEDUNUME", "name": "ALLIANCE DU NUMERIQUE", "payment_terms": "30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement et virement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr", "tva_intracom": "293"}}, {"id": "SUP-MARCEACONSEIL", "name": "MARCEA CONSEIL", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-SOFTVALUE", "name": "SOFT VALUE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement et carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-OLIVIERASSURAN", "name": "OLIVIER ASSURANCES", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-CDISCOUNT", "name": "CDISCOUNT", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-LDLC", "name": "LDLC", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-PRESTASHOP", "name": "PRESTASHOP", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "facture"}}, {"id": "SUP-CDKAVOCAT", "name": "CDK AVOCAT", "payment_terms": "15 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-CRISRESEAUXSEC", "name": "CRIS RESEAUX & SECURITE", "payment_terms": "immédiat fdm30", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-SOSH", "name": "SOSH", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-ENIFORMATION", "name": "ENI FORMATION", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-MANATEL", "name": "MANATEL", "payment_terms": "immédiat fdm30", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-NANTEST", "name": "NANT'EST", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-ORANGE", "name": "ORANGE", "payment_terms": "Bonjour,", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement"}}, {"id": "SUP-RDPSOFT", "name": "RDPSOFT", "payment_terms": "244", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-FACTORIAL", "name": "FACTORIAL", "payment_terms": "Pouvez-vous m’envoyer le Grand Livre des paiements et factures 2025 et 2024 ?", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement", "invoice_mailbox": "facture"}}, {"id": "SUP-LAPOSTE", "name": "LAPOSTE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement et carte"}}, {"id": "SUP-SENECTIC", "name": "SENECTIC", "payment_terms": "En vous remerciant,", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "facture"}}, {"id": "SUP-CENTREAUTONANT", "name": "CENTRE AUTO NANTES", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-EBAY", "name": "EBAY", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-TRADEMOS", "name": "TRADEMOS", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-SOFT4EUROPE", "name": "SOFT 4 EUROPE", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement et carte", "invoice_mailbox": "facture"}}, {"id": "SUP-BROTHER", "name": "BROTHER", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-BUREAUVALLEE", "name": "BUREAU VALLEE", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-STUDIOCALL", "name": "STUDIOCALL", "payment_terms": "30 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-INDEED", "name": "INDEED", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-CIDEMA", "name": "CIDEMA", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-WPALLIMPORT", "name": "WP ALL IMPORT", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "facture"}}, {"id": "SUP-LEDEBOUCHEUR", "name": "LE DEBOUCHEUR", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement"}}, {"id": "SUP-OBOCK", "name": "OBOCK", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-MAILJET", "name": "MAILJET", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-GRAVITYFORMS", "name": "GRAVITY FORMS", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-GENERALI", "name": "GENERALI", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-IBIS", "name": "IBIS", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-FEUVERT", "name": "FEU VERT", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ONOFFTELECOM", "name": "ONOFF TELECOM", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "facture"}}, {"id": "SUP-DUPLICATOR", "name": "DUPLICATOR", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-AGIRRECOUVREME", "name": "AGIR RECOUVREMENT", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-CONTROLETECHNI", "name": "CONTROLE TECHNIQUE OUEST", "payment_terms": "15 jours", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-RKTECH", "name": "RK TECH", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-EDOC", "name": "EDOC", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement"}}, {"id": "SUP-ELECLERC", "name": "E.LECLERC", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ELEMENTOR", "name": "ELEMENTOR", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-AXA", "name": "AXA", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-CANVA", "name": "CANVA", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ENVATO", "name": "ENVATO", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-GREFFEDUTRIBUN", "name": "GREFFE DU TRIBUNAL DE COMMERCE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "282"}}, {"id": "SUP-ONTHEGOSYSTEM", "name": "ON THE GO SYSTEM", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ATELIERPORTABL", "name": "ATELIER PORTABLE", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ADAPTATEURPC", "name": "ADAPTATEUR-PC", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-MICROSOFT", "name": "MICROSOFT", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-CASTORAMA", "name": "CASTORAMA", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-ALIEXPRESS", "name": "ALIEXPRESS", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-LIFEAZ", "name": "LIFEAZ", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "prélèvement"}}, {"id": "SUP-COMPLIANZ", "name": "COMPLIANZ", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-WPMDIA", "name": "WP Média", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-DRISTELLAR", "name": "DRI STELLAR", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-NETLYON", "name": "NET LYON", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-3PP", "name": "3PP", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-RUEDUCOMMERCE", "name": "RUE DU COMMERCE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-REMARKABLEAS", "name": "REMARKABLE AS", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte", "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-ADOBE", "name": "ADOBE", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-OSCARO", "name": "OSCARO", "payment_terms": "immédiat", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "carte"}}, {"id": "SUP-EASYTEO", "name": "EASYTEO", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-MAILINBLACK", "name": "MAILINBLACK", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "payment_type": "virement", "invoice_mailbox": "facture"}}, {"id": "SUP-KOESIO", "name": "KOESIO", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "invoice_mailbox": "demander d'envoyer les factures à facture@astorya,fr"}}, {"id": "SUP-TEAMVIEWER", "name": "TEAM VIEWER", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "invoice_mailbox": "facture demander à laurent si non recu"}}, {"id": "SUP-LOCAM", "name": "LOCAM", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2, "invoice_mailbox": "facture"}}, {"id": "SUP-HOPLA", "name": "HOPLA", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}, {"id": "SUP-SOFTCONNECT", "name": "SOFT CONNECT", "payment_terms": "", "data": {"cost_bracket": "-5 000€", "importance": "secondaire", "importance_note": 2}}];
    ...
    return {
      async list({ active = true } = {}) {
        ...
        if (s) {
          ...
          if (error && !isMissingTable(error)) { console.warn("[suppliers.list]", error.message); return []; }
          // table vide OU absente → on retombe sur le cache local / les défauts
        }
        // Fallback localStorage : si vide, on amorce avec les 109 fournisseurs
        // importés du tableau compta (SUPPLIER_DEFAULTS).
        let arr = lsList();
        if (!arr.length) { arr = SUPPLIER_DEFAULTS.map((r) => ({ active: true, ...r })); lsSave(arr); }
      ...
      async stats() {
        const arr = await this.list({ active: true });
        const by = { strategique: 0, important: 0, standard: 0, secondaire: 0 };
        (arr || []).forEach((r) => { const k = (r.data && r.data.importance) || "secondaire"; if (by[k] != null) by[k]++; });
        return { total: arr.length, byImportance: by };
      },
