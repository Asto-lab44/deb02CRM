              ...
              <div style={{ background: "#fafbfc", border: "1px solid #e2e8f0", borderRadius: 10, padding: 14, marginBottom: 18, fontSize: 12 }}>
                ...
                <table style={{ width: "100%", fontSize: 12 }}>
                  <tbody>
                    ...
                    {result.company.capital && <tr><td style={{ color: "#64748b", padding: "3px 0" }}>Capital</td><td style={{ padding: "3px 0", fontVariantNumeric: "tabular-nums" }}>{Number(result.company.capital).toLocaleString("fr-FR")} €</td></tr>}
