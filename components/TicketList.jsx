...
const TicketList = () => {
  ...
  const tickets = liveTickets || [
    ...
    { id: "INC-2833", client: { name: "Allianz France",       maintenance: "expiring", contract: "Standard 9-18h · expire le 12 juil. 2026 (46 j)" }, title: "Outlook : pièces jointes >25 Mo bloquées", status: "in_progress", prio: "normale", cat: "Messagerie", assignee: { name: "Romain Daviaud", team: "Support N1" }, opened: "il y a 2 j", updated: "hier", sla: { left: "5 h 10", risk: "ok" }, msgs: 3, unread: 0, hasAttach: false },
