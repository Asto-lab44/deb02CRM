...
## Le logiciel est offert — les services qui le font tourner sont notre métier

Le **logiciel Hub Astorya** vous est mis à disposition **gratuitement**. Ce qui a de la valeur, et ce qui fait notre métier, c'est de le faire fonctionner pour vous **de manière fiable, sécurisée et continue** :

- 🖥 **Hébergement** sur notre infrastructure souveraine française
- 🗄 **Gestion de la base de données** (administration, optimisation, supervision)
- 🔐 **Certificats SSL/TLS** gérés et renouvelés automatiquement
- 💾 **Sauvegardes quotidiennes chiffrées** (rétention 30 jours) et plan de reprise
- 🛠 **Maintenance corrective** (correctifs, sécurité) et **maintenance évolutive**
- 🧩 **TMA** (Tierce Maintenance Applicative) : adaptations, support, accompagnement
- 🛡 **Cellule sécurité** et supervision

Ces services sont fournis dans le cadre d'un **contrat commercial d'hébergement et de maintenance**, qui constitue le modèle économique de la solution.

> **En clair** : le logiciel ne vous coûte rien. Vous payez uniquement les services d'infrastructure et de maintenance qui garantissent sa disponibilité, sa sécurité et son évolution — comme vous payeriez l'électricité d'une machine que l'on vous aurait offerte.

Vous n'avez **rien à installer** et **rien à administrer** vous-même.
...
L'accès gratuit au **logiciel** Hub Astorya est strictement réservé aux **clients ayant souscrit le contrat commercial d'hébergement et de maintenance** auprès d'Astorya SGI. Ce contrat couvre l'hébergement, la gestion de la base de données, les certificats SSL, les sauvegardes, la maintenance corrective et évolutive, et la TMA.

L'accès au logiciel cesse 30 jours après la fin du contrat de services, période pendant laquelle l'export des données reste garanti.

La mise à disposition du logiciel et la fourniture des services associés sont encadrées par deux documents complémentaires : le **contrat de mise à disposition gratuite du logiciel** (gratuité, propriété des données, réversibilité, sécurité) et le **contrat commercial de services** (hébergement, maintenance, TMA, tarification).
...
Il n'y a pas de modèle freemium caché, pas de licence à upgrader. **Le logiciel est et restera gratuit pour les clients sous contrat de services actif.**
...
| Élément | Tarif |
|---|---|
| **Le logiciel Hub Astorya** (droit d'usage, toutes les fonctionnalités, mises à jour) | ✅ **Gratuit** |
| **Hébergement** sur infrastructure souveraine française | 💼 Contrat de services |
| **Gestion de la base de données** (administration, supervision, optimisation) | 💼 Contrat de services |
| **Certificats SSL/TLS** (émission, renouvellement, monitoring) | 💼 Contrat de services |
| **Sauvegardes quotidiennes chiffrées** + plan de reprise d'activité | 💼 Contrat de services |
| **Maintenance corrective** (correctifs, patchs de sécurité) | 💼 Contrat de services |
| **Maintenance évolutive / TMA** (nouvelles fonctions, adaptations) | 💼 Contrat de services |
| **Support et accompagnement** | 💼 Contrat de services |

Autrement dit : **on vous offre l'outil, on vous facture le carburant et l'entretien.** C'est le contrat commercial d'hébergement et de maintenance qui fait vivre la solution et finance son évolution continue.

## Qui peut en bénéficier ?

Tout **client Astorya SGI ayant souscrit le contrat d'hébergement et de maintenance** du Hub. Ce contrat peut être autonome ou intégré à un contrat de services plus large (infogérance, cloud privé, support).

Le bénéfice du Hub est attaché au compte client, non aux utilisateurs individuels. Vous pouvez ouvrir autant de comptes utilisateurs que nécessaire dans votre entreprise (selon votre offre de services).
...
✅ **Le logiciel est offert** — droit d'usage gratuit, toutes les fonctionnalités, mises à jour incluses
💼 **Les services sont notre métier** — hébergement, gestion de la base, SSL, sauvegardes, maintenance et TMA via un contrat commercial dédié (c'est ce qui fait vivre et évoluer la solution)
✅ **Vos données vous appartiennent** — export complet sur simple demande
✅ **Réversibilité totale** — vous arrêtez quand vous voulez, vous repartez avec tout
...
Le modèle retenu par le Prestataire repose sur une distinction fondamentale :

- **Le Logiciel** (droit d'usage) est mis à disposition à titre **gracieux**, et fait l'objet du présent contrat ;
- **Les services techniques** indispensables à son fonctionnement — hébergement, administration de la base de données, certificats de sécurité, sauvegardes, maintenance et tierce maintenance applicative (TMA) — sont fournis à titre **onéreux** dans le cadre d'un **contrat commercial de services distinct** (ci-après « le Contrat de Services »), qui constitue le modèle économique de la solution.

Le bénéfice du présent contrat est par conséquent **indissociable** de la souscription et du maintien en vigueur du Contrat de Services.

Le Client, souhaitant bénéficier du Logiciel, a souscrit ou souscrit concomitamment le Contrat de Services auprès du Prestataire.
...
Le présent contrat ne couvre **pas** la fourniture des services techniques d'exploitation du Logiciel, lesquels relèvent du Contrat de Services visé à l'article 2 bis.

---

## ARTICLE 2 — CONDITIONS D'ÉLIGIBILITÉ

L'accès au Logiciel est conditionné à l'existence d'un **Contrat de Services actif** entre le Client et le Prestataire (cf. article 2 bis), le cas échéant intégré à un contrat de services plus large parmi les catégories suivantes :

- Contrat d'hébergement et de maintenance du Hub Astorya
...
🛡 **Article 2.1 — Cessation automatique** : la résiliation, la non-reconduction ou la rupture pour quelque motif que ce soit du Contrat de Services entraîne, **de plein droit et sans formalité**, la suspension de l'accès au Logiciel à l'issue du préavis défini à l'article 11.

---

## ARTICLE 2 BIS — SERVICES TECHNIQUES ASSOCIÉS (CONTRAT DE SERVICES) 💼

**Article 2 bis.1** — Le fonctionnement du Logiciel nécessite la fourniture par le Prestataire de services techniques d'exploitation, lesquels font l'objet d'un **contrat commercial distinct**, facturé selon la grille tarifaire en vigueur. Ces services comprennent notamment :

- **Hébergement** du Logiciel et des données sur l'infrastructure du Prestataire
- **Administration et supervision de la base de données** (PostgreSQL/Supabase) : optimisation, monitoring, gestion des accès
- **Gestion des certificats SSL/TLS** : émission, renouvellement automatique, surveillance d'expiration
- **Sauvegardes quotidiennes chiffrées**, réplication géographique et plan de reprise d'activité (PRA)
- **Maintenance corrective** : correction des anomalies, application des correctifs de sécurité
- **Maintenance évolutive et Tierce Maintenance Applicative (TMA)** : nouvelles fonctionnalités, adaptations spécifiques, montées de version
- **Support technique** et accompagnement des utilisateurs

**Article 2 bis.2** — Les conditions financières, le niveau de service (SLA), les modalités d'exécution et de révision tarifaire de ces prestations sont définis dans le Contrat de Services et son annexe tarifaire, qui prévalent sur le présent contrat pour tout ce qui concerne lesdits services.

**Article 2 bis.3** — La gratuité du droit d'usage du Logiciel (article 4) ne saurait être interprétée comme emportant gratuité des services techniques associés, lesquels demeurent dus selon le Contrat de Services tant que celui-ci est en vigueur.

🛡 **Article 2 bis.4 — Indépendance des engagements de sécurité et de réversibilité** : nonobstant le caractère onéreux du Contrat de Services, les engagements du Prestataire en matière de **propriété des données** (article 5), de **sécurité** (article 7), de **conformité RGPD** (article 8) et de **réversibilité** (article 9) demeurent dus en toutes circonstances, y compris en cas de litige financier relatif au Contrat de Services. En particulier, **l'export des données du Client ne peut en aucun cas être conditionné au paiement de sommes dues** au titre du Contrat de Services.
...
## ARTICLE 4 — GRATUITÉ DU DROIT D'USAGE DU LOGICIEL

**Article 4.1** — Le **droit d'usage du Logiciel** objet du présent contrat est **strictement gratuit**. Aucune redevance de licence, frais de mise à disposition, frais d'utilisateur supplémentaire ou frais d'acquisition du droit d'usage ne pourra être réclamé par le Prestataire au Client au titre de la présente mise à disposition.

**Article 4.2 — Périmètre de la gratuité** : la gratuité porte exclusivement sur le **droit d'usage du Logiciel** et l'accès à ses fonctionnalités. Elle **ne comprend pas** les services techniques d'exploitation (hébergement, base de données, SSL, sauvegardes, maintenance, TMA, support) visés à l'article 2 bis, lesquels sont facturés au titre du Contrat de Services.

🛡 **Article 4.3** — Le Prestataire s'engage à maintenir la gratuité du droit d'usage du Logiciel pendant toute la durée du présent contrat. Toute modification ultérieure consistant à rendre le droit d'usage du Logiciel lui-même payant ne pourra être imposée au Client qu'après signature d'un avenant explicite, et donnera lieu, en cas de refus du Client, à une période transitoire d'utilisation gratuite minimale de **12 mois** afin de permettre au Client de migrer vers une solution alternative. La présente clause ne fait pas obstacle à la révision des tarifs du Contrat de Services, qui obéit à ses propres modalités.
...
🛡 **Article 11.4 — Aucun frais de sortie sur le Logiciel et les données**
Aucun frais de résiliation du droit d'usage du Logiciel, de migration des données ou d'export ne peut être facturé au Client. La gratuité de l'export et de la réversibilité (article 9) est **absolue et non négociable**, y compris en cas de sommes restant dues au titre du Contrat de Services. Les conditions de résiliation et de facturation propres au Contrat de Services (préavis, solde des prestations en cours) demeurent régies par ce dernier.

---

## ARTICLE 12 — RESPONSABILITÉ ET GARANTIE DE SERVICE

**Article 12.1 — Disponibilité et niveau de service**
Le taux de disponibilité du Logiciel, les engagements de niveau de service (SLA), les délais d'intervention et les pénalités éventuelles sont définis dans le **Contrat de Services** (cf. article 2 bis), dès lors qu'ils relèvent de l'exploitation technique facturée. À titre indicatif, le Prestataire vise une disponibilité de **99,5 % par mois civil** hors maintenance planifiée annoncée 48 heures à l'avance.

**Article 12.2 — Maintenance**
La maintenance corrective, la maintenance évolutive et la TMA sont fournies dans le cadre du Contrat de Services. Le présent contrat n'emporte aucune obligation de maintenance à titre gratuit.

**Article 12.3 — Limitation de responsabilité**
Le droit d'usage du Logiciel étant concédé à titre gratuit, la responsabilité du Prestataire au titre du **présent contrat** est limitée aux cas de **faute lourde, dol ou manquement caractérisé** aux obligations essentielles définies aux articles 5, 7, 8 et 9. La responsabilité du Prestataire au titre des services facturés relève du régime défini par le Contrat de Services.
...
## ANNEXE 5 — Contrat de Services : prestations et tarification (modèle) 💼

> Cette annexe matérialise le **modèle économique** : le Logiciel est gratuit, les services ci-dessous sont facturés. Grille à adapter selon ton offre commerciale.

### Prestations incluses

| Prestation | Description | Inclus / Option |
|---|---|---|
| **Hébergement** | Mise à disposition de l'infrastructure (application + base de données), bande passante, supervision | Inclus |
...
- Facturation : mensuelle / trimestrielle / annuelle (à définir)
- Révision tarifaire : annuelle, indexée sur l'indice Syntec (à confirmer)
- Préavis de résiliation du Contrat de Services : _______ mois
- Le détail définitif est fixé dans le bon de commande / devis signé par le Client.
