                    ...
                    return (
                      <div key={key} style={{
                        ...
                        {(() => {
                          ...
                          const isEmail = (a.tag || "").toLowerCase() === "email" ||
                          ...
                          if (!isEmail) return <div style={baseStyle}>{a.icon}</div>;
                          ...
                          return (
                            <a href={href}
                               ...
                               onMouseEnter={(e) => { e.currentTarget.style.transform = "scale(1.1)"; e.currentTarget.style.boxShadow = "0 2px 8px rgba(15,23,42,0.12)"; }}
