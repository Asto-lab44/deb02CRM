...
var ClientPage = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("button", {
          ...
          onClick: e => {
            ...
            if (/pr[ée]sentation/i.test((a.title || "") + " " + (a.meta || "")) || a.tag === "Emailing") {
              ...
              window.location.href = "mailto:" + recipient + "?subject=" + encodeURIComponent("Présentation de l'entreprise informatique téléphonie ASTORYA S.G.I.") + (presoBody ? "&body=" + encodeURIComponent(presoBody) : "");
    ...
    }, c.pappers.dirigeants.map((d, i) => /*#__PURE__*/React.createElement("span", {
      key: i,
      style: {
        fontSize: 12,
        background: "#f0f9ff",
    ...
    }, c.pappers.procedures.map((p, i) => /*#__PURE__*/React.createElement("span", {
      key: i,
      style: {
        fontSize: 12,
        color: "#b91c1c",
